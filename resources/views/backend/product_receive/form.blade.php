                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" id="item_id" name="item_id" required onchange="get_product_by_item_id(this.value);">
                    ...
                    <td colspan="2">
                        <div class="form-group">
                            <label for="name" class="col-md-4 required">Products</label>
                            <div class="col-md-8">
