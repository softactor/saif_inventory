        ...
        <table class="table" style="width: 96%;">
            <tbody>
                <tr>
                    ...
                    <td colspan="2">
                        <div class="form-group">
                            <label for="name" class="col-md-4">Issue No</label>
                            <div class="col-md-8">
...
?>
        ...
        <input type="hidden" id='process_product_issue_url' value="<?php echo route('admin.product_challan.process_product_issue_url'); ?>" />
    </div>
</div>