...
<tr>
    <td colspan="7" style="text-align: right;">
        <?php $url    =  route('admin.product_requisition.store');   ?>
        <button type="button" class="btn btn-success btn-sm" onclick="saveproductRequisitionDetails('<?php echo $data->receive_no ?>','<?php echo $url; ?>');">Save</button>
